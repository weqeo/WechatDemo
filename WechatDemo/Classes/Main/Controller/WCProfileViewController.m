...
-(void)loadVCard{
    ...
    XMPPvCardTemp *myVCard =[WQXMPPTool sharedWQXMPPTool].vCard.myvCardTemp;
    ...
    self.weixinNumLabel.text = [WQUserInfo sharedWQUserInfo].user;
...
-(void)editProfileViewControllerDidSave{
    ...
    [[WQXMPPTool sharedWQXMPPTool].vCard updateMyvCardTemp:myvCard];
